...
export default function AboutPage() {
  return <><Header /><main className="site-page about-page">
    <section><StandardHero src="/images/pages/about-hero.webp" alt="درباره کاغذ ۲۰ و محصولات Double A" imageClassName="!object-cover object-[52%_center] lg:object-center" /></section>
