...
export default function ContactPage(){return <><Header/><main className="site-page contact-page">
  <section><StandardHero src="/images/pages/contact-hero.webp" alt="تماس با ما" imageClassName="!object-cover object-[58%_center] lg:object-center" /></section>
  <div className="contact-columns">
    <section className="contact-info panel"><div className="contact-details">{[["ساعات کاری","شنبه تا پنجشنبه، ۸ تا ۱۸","clock"],["آدرس شرکت","تهران، بلوار میرداماد، خیابان کازرون شمالی، خیابان نیک‌رای، پلاک ۲، طبقه سوم، واحد ۶","pin"],["ایمیل","info@kaghaz20.ir","mail"],["تماس تلفنی","۰۹۳۸۲۳۰۲۹۳۰","phone"]].map(x=><div key={x[0]}><PageIcon name={x[2]}/><span><b>{x[0]}</b><small>{x[1]}</small></span></div>)}</div><div className="map"><Image src="/images/pages/contact-map.png" alt="موقعیت شرکت کاغذ ۲۰" fill sizes="70vw"/></div><h3>شرکت کاغذ ۲۰</h3><p>تهران، بلوار میرداماد، خیابان کازرون شمالی، خیابان نیک‌رای، پلاک ۲، طبقه سوم، واحد ۶</p></section>
