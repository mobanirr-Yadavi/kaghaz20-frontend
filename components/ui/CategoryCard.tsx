...
export function CategoryCard({ category }: CategoryCardProps) {
  if (category.dark) {
    return (
      <a className="flex h-[92px] min-w-0 items-center justify-center gap-2 rounded-lg bg-navy px-3 text-white shadow-card transition hover:bg-deepNavy sm:h-[76px]" href="#">
  ...
  if (category.featured) {
    return (
      <a className="flex h-[92px] min-w-0 items-center gap-2 rounded-lg border border-[#F0DDAE] bg-white px-3 shadow-card transition hover:-translate-y-0.5 sm:h-[76px]" href="#">
  ...
  return (
    <a className="flex h-[92px] min-w-0 items-center justify-between gap-2 rounded-lg bg-white px-3 shadow-card transition hover:-translate-y-0.5 sm:h-[76px] sm:px-4" href="#">
      <div>
