...
export async function AccountDashboardPage({ adminView = "overview" }: { adminView?: AdminView }) {
  ...
  return <AdminDashboard view={adminView} profile={profile} stats={stats} orders={orders} users={users} products={products} categories={categories} />;
}
